...
#class.
# I was not aware of the dictionary structure, so did it with lists instead. Understood what dictionaries are and why we should use them here instead of list.
